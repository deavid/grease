...
class SVG(object):
    ...
    _disp_list_cache = {}
    def __init__(self, filename, anchor_x=0, anchor_y=0, bezier_points=BEZIER_POINTS, circle_points=CIRCLE_POINTS, reversed_order = False):
    ...
    def parse_float(self, txt):
        re_var = re.match("^([0-9.]+)([a-z]*)$", txt)
        value, unit = re_var.groups()
        return float(value)
